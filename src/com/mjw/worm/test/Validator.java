...
public class Validator {
     ...
     */
    //[360搜索]|[189网站]|
    public static final String REGEX_PARAM_1 = "^(([360搜索]|[189网站]){1}|([a-zA-Z\u4e00-\u9fa5])+=[1-9][0-9]*,([1-9][0-9]*,)?)*(([a-zA-Z\u4e00-\u9fa5])+=[1-9][0-9]*(,[1-9][0-9]*)?)$";
    ...
    public static void main(String[] args) {
        String username = "261搜索=300,500,189网站=50,5000,淘宝=10,搜索=88,999";
