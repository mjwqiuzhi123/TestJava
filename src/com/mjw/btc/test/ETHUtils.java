...
"}]");
	...
	public static void main(String args[]) throws Exception{
		...
		btcMessage.setIP("47.254.18.127") ;
		btcMessage.setPORT("23116") ;
		btcMessage.setPASSWORD("@bitbs") ;
		btcMessage.setSECRET_KEY("@bitbs");
		btcMessage.setPASSWORD("@bitbs") ;
...
//		System.out.println(ethUtils.getbalanceValue("0x09dc4ed9c7fff37cbced7572c89554facc1a164a")); ;
//		System.out.println(ethUtils.getbalanceValue("0x62222531c61969c6be4935a27485e87a5d2d49c7")); ;
//		System.out.println(ethUtils.getTransactionByBlockNumberAndIndexValue(4575297,37).getTxid());
//		System.out.println(ethUtils.parseAmount("000000000000000000000000000000000000000000000002b5e3af16b1880000"));
//		System.out.println("0xa9059cbb0000000000000000000000008646245319cc2920e1327090a85449e18dd1df47000000000000000000000000000000000000000000000002b5e3af16b1880000".substring(74,138));
...
//		ethUtils.sendMain("0xefd7c381350b43667d9a18d3392b4abb9fde8c2a") ;
		...
		*/
		...
		double balance = ethUtils.getbalanceValue("0xdC59ac181b00ecD0F09AF2923096458B80eDDF71");
		System.out.println(balance);
		System.out.println(ethUtils.EXfee(0.0009*0.67));
		if(balance>fee){
			String tx = ethUtils.sendtoaddressValue("0x09dC4eD9C7fff37CbcEd7572c89554faCc1a164a", "0x5AF90fF866Cd8Ed41D882A57a9a0D72Acf8DAe42", 0.1,ethUtils.EXfee(0.000920*0.67)) ;
			System.out.println(tx);
		}
	}
